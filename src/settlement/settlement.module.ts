...
@Module({
  ...
  providers: [SettlementService, SolanaSettlementService, SettlementRouterService, X402VerifierService, X402StakeController],
  exports: [SettlementService, SolanaSettlementService, SettlementRouterService, X402VerifierService, X402StakeController],
})
